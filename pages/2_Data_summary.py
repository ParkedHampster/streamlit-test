...
st.image('img/penguins.jpg', use_column_width='always')
...
st.write(penguins.sample(15))

penguin_species = penguins.drop(columns=['island']).groupby(['species','sex']).agg(np.mean)
